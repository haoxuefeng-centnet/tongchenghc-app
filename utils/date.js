...
module.exports = {
	...
	// 时间戳转
  // returnType (YY-mm-dd) (YY-mm-dd HH:ii:ss)
	formatDateTime : function(timeStamp, dateType){
    dateType = dateType || 'YY-mm-dd' // 默认转换格式
		var date = new Date();
    ...
    if (dateType == 'YY-mm-dd') {
     return y + '-' + m + '-' + d
    } else if (dateType == 'YY-mm-dd HH:ii:ss') {
     return y + '-' + m + '-' + d + ' '+ h +':' + minute + ':' + second 
    } else {
      console.error('时间戳转换失败！')
    }
	},
